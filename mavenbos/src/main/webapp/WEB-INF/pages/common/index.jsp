...
<script type="text/javascript">
	...
	$(function() {
		...
		// 基本功能菜单加载
		$.post("${pageContext.request.contextPath}/function_showmenu.action",function(data){
		...
		$("#btnEp").click(function(){
			...
			// 发起Ajax请求 
			$.post("${pageContext.request.contextPath}/user_editpassword.action"
					,{password:txtNewPass}, function(data){
				if(data.result){
...
<body class="easyui-layout">
	<div data-options="region:'north',border:false"
		...
		<div id="sessionInfoDiv"
			...
			[<strong><shiro:principal property="username" /> </strong>]，
