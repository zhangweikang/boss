...
<script type="text/javascript">
	...
	$(function(){
		...
		$("#btn").click(function(){
			...
			// 当将条件 给了datagrid后，调用load方法，自动发起新的请求 
	...
	<div class="easyui-window" title="分区添加修改" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="subareaForm" method="post"
				action="${pageContext.request.contextPath }/subarea_save.action">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>选择区域</td>
						<td>
							<!-- mode为remote ，输入内容后，自动向服务器 发送一个q 参数 -->
							<input class="easyui-combobox" name="region.id"  
    							data-options="valueField:'id',textField:'name',mode:'remote', required:true,
    								url:'${pageContext.request.contextPath }/region_ajaxlist.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
	...
	<div class="easyui-window" title="查询分区窗口" id="searchWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="searchForm" method="post"
				action="${pageContext.request.contextPath }/subarea_searchDownload.action">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
